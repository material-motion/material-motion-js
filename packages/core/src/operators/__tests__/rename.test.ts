...
describe('motionObservable.rename',
  () => {
    let subject;
    let argSubject;
    let listener;
    ...
    it('should rename the keys in its upstream value and emit the result',
      () => {
        subject.rename({ width: 'x', height: 'y' }).subscribe(listener);
    ...
    it('should support the kwargs pattern',
      () => {
    ...
    it('should ignore unmapped names',
      () => {
        ...
        subject.next({ width: 3, height: 10, depth: 7 });
