 ...
 */
export const MotionObservable: ObservableConstructor<T> = addOperators<T>(
class StaticMotionObservable<T> extends IndefiniteObservable<T> {
  /**
